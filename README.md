...
assets/: Image assets for the simulation (e.g., car.png, amu.png, car1.png, etc.).
...
Place image assets in the same directory as the script or update paths accordingly.
